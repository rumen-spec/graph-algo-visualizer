import { MAX_COLS, MAX_ROWS } from "../../util/consts.ts";
import { createWall } from "../../util/createWall";
import { destroyWall } from "../../util/destroyWall.ts";
import { getRandInt, isEqual, sleep } from "../../util/helper.ts";
import { GridType, SpeedType, TileType } from "../../util/types.ts";
